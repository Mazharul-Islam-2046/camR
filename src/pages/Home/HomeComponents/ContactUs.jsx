...
const ContactUs = () => {
    ...
    return (
        <div id="contactme" className="flex flex-col py-8 items-center mt-24 -mb-20">
            <h2 className="text-3xl md:text-4xl text-gray-900 font-secondary font-bold mt-8 uppercase">Contact Me</h2>
            <form
            ...
            >
                ...
                <button className="bg-gray-900 rounded-md text-white py-3 hover:text-gray-800 hover:bg-white border-gray-800 hover:border-2" type="submit">Send</button>
            </form>
        </div>
    );
};
