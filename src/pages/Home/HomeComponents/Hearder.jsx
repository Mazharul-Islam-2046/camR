...
const Hearder = () => {
    ...
    return (
        <div className="bg-black h-[80vh] lg:h-screen relative text-white">
            ...
            {/* Header Content */}
            <div className="absolute top-0 w-full flex flex-col text-center mt-28 lg:mt-44">
            <h1 className="font-secondary font-bold text-xl lg:text-4xl lg:leading-10">
            ...
            <p className="text-sm lg:text-lg lg:mt-4 mb-12 font-primary">
            ...
            <div className="space-x-4">
                ...
                <NavLink to='/dashboard/addproducts' className= {({isActive}) => isActive ? `text-black bg-white ${headerBtnStyle}` : `text-white hover:bg-white hover:text-black ${headerBtnStyle}`}>
                    Add
                </NavLink>
            </div>
            </div>
