  ...
  return (
    <div className="w-full">
      ...
      <form onSubmit={handleEdit} className="flex flex-col w-full gap-2 text-white bg-transparent" action="">
        ...
        <input className="bg-gray-600 border-b-2 border-white rounded-sm font-primary hover:bg-gray-500 cursor-pointer font-bold py-3" type="submit" value="Edit Product" />
      </form>
    </div>
  );
};
